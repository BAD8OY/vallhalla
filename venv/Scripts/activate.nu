...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\maksg\OneDrive\Desktop\python programs\vallhalla\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\maksg\OneDrive\Desktop\python programs\vallhalla\venv\Scripts\deactivate.nu'
